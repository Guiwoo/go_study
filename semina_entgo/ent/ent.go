...
// NotFoundError returns when trying to fetch a specific dto and it was not found in the database.
...
// NotSingularError returns when trying to fetch a singular dto and more then one was found in the database.

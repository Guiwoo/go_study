...
func (pu *PetUpdate) SetSex(s string) *PetUpdate {
	pu.mutation.SetSex(s)
	return pu
}

// SetNillableSex sets the "sex" field if the given value is not nil.
func (pu *PetUpdate) SetNillableSex(s *string) *PetUpdate {
	if s != nil {
		pu.SetSex(*s)
	}
	return pu
...
func (pu *PetUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.Sex(); ok {
		_spec.SetField(pet.FieldSex, field.TypeString, value)
	}
...
// SetSex sets the "sex" field.
func (puo *PetUpdateOne) SetSex(s string) *PetUpdateOne {
	puo.mutation.SetSex(s)
	return puo
}

// SetNillableSex sets the "sex" field if the given value is not nil.
func (puo *PetUpdateOne) SetNillableSex(s *string) *PetUpdateOne {
	if s != nil {
		puo.SetSex(*s)
	}
	return puo
